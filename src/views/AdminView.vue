<template>
    ...
    <EditComponentsProf @reload="loadEvents()" :prof="editEventsData" v-if="isEditEventsOpened" @close="closeEditEvents()"/>
    <AddComponentsProf @reload="loadEvents()" v-if="isAddEventsOpened" @close="closeAddEvents()"/>
...
<script setup lang="ts">
    ...
    import EditComponentsEvents from "@/components/EditComponentsPlaces.vue";
    import AddComponentsEvents from "@/components/AddComponentsPlaces.vue";
